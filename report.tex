...
Esistono inoltre ulteriori vincoli. Uno di questi è quello in cui per poter aver un numero di volte in cui una carta è stata giocata in una partita maggiore di zero, è necessario che la carta appartenga ad almeno uno due mazzi che sono stati giocati in partita. Per imporlo abbiamo deciso il seguente trigger:
\begin{lstlisting}[ language=SQL,
                    deletekeywords={IDENTITY},
                    deletekeywords={[2]INT},
                    morekeywords={REFERENCES},
